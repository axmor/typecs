...
public class ArrayValue extends Value implements IIndexedValue {
  ...
  public ArrayValue(JsEvaluateContext evaluateContext, IDebugTarget debugTarget, JsArray array,
  ...
  private IVariable[] createElements() {
    ...
    return TypeScriptStackFrame.wrapVariables(getEvaluateContext(), getDebugTarget(), jsArray.getProperties(),
