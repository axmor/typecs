...
public class TypeScriptConsoleManager {
    ...
    /**
     * Terminates the execution of the given console and removes it from the list of available
     * consoles.
     * 
     * @param console
     *            the console to be terminated and removed.
     */
     ...
     * 
     * @param console
     *            the console to be added to the console view
     * @param show
