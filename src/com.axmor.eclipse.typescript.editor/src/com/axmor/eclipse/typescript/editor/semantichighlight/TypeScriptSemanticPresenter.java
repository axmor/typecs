...
public class TypeScriptSemanticPresenter implements ITextPresentationListener, ITextInputListener, IDocumentListener {
    ...
    private TypeScriptProjectionViewer fSourceViewer;
    ...
    public TextPresentation createPresentation(List<Position> addedPositions, List<Position> removedPositions) {
        ...
        TypeScriptPresentationReconciler presentationReconciler = fPresentationReconciler;
    ...
    public Runnable createUpdateRunnable(final TextPresentation textPresentation, List<Position> addedPositions,
        ...
        final HighlightedPosition[] added = new TypeScriptSemanticManager.HighlightedPosition[addedPositions.size()];
        addedPositions.toArray(added);
        final TypeScriptSemanticManager.HighlightedPosition[] removed = new TypeScriptSemanticManager.HighlightedPosition[removedPositions
                .size()];
     ...
     */
    public void install(ISourceViewer sourceViewer, TypeScriptPresentationReconciler backgroundPresentationReconciler) {
        fSourceViewer = (TypeScriptProjectionViewer) sourceViewer;
        fPresentationReconciler = backgroundPresentationReconciler;

        ((TypeScriptProjectionViewer) fSourceViewer).prependTextPresentationListener(this);
