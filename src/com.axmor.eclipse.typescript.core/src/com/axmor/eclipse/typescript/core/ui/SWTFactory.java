...
/**
 * Factory class to create some SWT resources. Copied from org.eclipse.debug.internal.ui.SWTFactory.
 * 
 * @author Konstantin Zaitcev
 */
public final class SWTFactory {

    /** Limit to display combos value. */
    private static final int COMBO_COUNT_LIMIT = 30;
     ...
     *            the font to set on the control
     * @param style
     *            the style bits for the composite. See {@link Composite} for details on supported
     *            style bits
     * @param columns
     *            the number of columns within the composite
     * @param hspan
    ...
    public static Combo createCombo(Composite parent, int style, int hspan, int fill, String[] items) {
        ...
        c.setVisibleItemCount(COMBO_COUNT_LIMIT);
        c.select(0);
        return c;
    }
